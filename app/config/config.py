...
class Settings(BaseSettings):
    ...
    minio_bucket_name: str = Field(default = 'profile-picture', description="minio bucket name")
    minio_public_endpoint: str = Field(default = 'localhost:9001', description = "minio UI endpoint")
